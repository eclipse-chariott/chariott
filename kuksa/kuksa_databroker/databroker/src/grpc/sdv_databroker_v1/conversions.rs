    ...
    fn from(datapoint: &broker::Datapoint) -> Self {
        let value = match &datapoint.value {
            ...
            broker::DataValue::BoolArray(array) => {
                proto::datapoint::Value::BoolArray(proto::BoolArray { values: array.clone() })
            }
            broker::DataValue::StringArray(array) => {
                proto::datapoint::Value::StringArray(proto::StringArray { values: array.clone() })
            }
            broker::DataValue::Int32Array(array) => {
                proto::datapoint::Value::Int32Array(proto::Int32Array { values: array.clone() })
            }
            broker::DataValue::Int64Array(array) => {
                proto::datapoint::Value::Int64Array(proto::Int64Array { values: array.clone() })
            }
            broker::DataValue::Uint32Array(array) => {
                proto::datapoint::Value::Uint32Array(proto::Uint32Array { values: array.clone() })
            }
            broker::DataValue::Uint64Array(array) => {
                proto::datapoint::Value::Uint64Array(proto::Uint64Array { values: array.clone() })
            }
            broker::DataValue::FloatArray(array) => {
                proto::datapoint::Value::FloatArray(proto::FloatArray { values: array.clone() })
            }
            broker::DataValue::DoubleArray(array) => {
                proto::datapoint::Value::DoubleArray(proto::DoubleArray { values: array.clone() })
            }
        ...
        proto::Datapoint { timestamp: Some(datapoint.ts.into()), value: Some(value) }
    }
}
...
impl From<&broker::DataValue> for proto::Datapoint {
    fn from(data_value: &broker::DataValue) -> Self {
        ...
        proto::Datapoint {
            timestamp: Some(SystemTime::now().try_into().unwrap()),
            value: Some(value),
        }
    }
}
